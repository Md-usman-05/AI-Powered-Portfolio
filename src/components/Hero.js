...
export default function Hero() {
  ...
  // --- 1. FUNCTION TO SCROLL TO SECTIONS (Prevents Router Issue) ---
  const handleScrollTo = (e, id) => {
    e.preventDefault(); // This stops the page from reloading/jumping
  ...
  // --- 2. FUNCTION FOR SCROLL INDICATOR ---
        ...
        <div className="max-w-5xl w-full mx-auto grid md:grid-cols-2 gap-8 md:gap-4 items-center">
          ...
          >
            ...
            <div className="text-xl md:text-2xl font-light text-slate-300 mb-6 h-[32px] flex items-center">
               AI Engineer <span className="ml-2"><Typewriter /></span>
            </div>
            ...
            {/* BUTTONS (UPDATED WITH CLICK HANDLERS) */}
            <div className="flex flex-wrap gap-3">
              <a 
                href="#projects" 
                onClick={(e) => handleScrollTo(e, 'projects')}
                className="group relative px-6 py-3 bg-white text-black font-bold rounded-lg overflow-hidden hover:scale-105 transition-transform shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]"
              >
              ...
              <a 
                ...
                className="px-6 py-3 bg-transparent border border-white/20 text-white font-bold rounded-lg hover:bg-white/5 hover:border-white/50 transition-all flex items-center gap-2 text-sm"
              >
                Contact Me
              </a>
            </div>
